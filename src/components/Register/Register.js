                ...
                <div className="measure">
                    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                        ...
                        <div className="mt3">
                            ...
                            <input className="pa2 input-reset ba bg-transparent hover-bg-blue  hover-white w-100" type="text" name="nickname"  id="nickname"/>
                        </div>
                        <div className="mt3">
                    ...
                    <div className="">
                        <input onClick={() => onRouteChange('home')} className="b ph3 pv2 input-reset ba b--blue bg-transparent grow pointer f6 dib pointer" type="submit" value="Register"/>
                    </div>
                </div>
            </main>
        </div>
